...
namespace AmphiprionCMS.Components
{
    public interface IImagingService
    {
        ...
        Image ScaleImage(Image image, int width, int height, bool zoomAndCrop = false);
    ...
    public  class ImagingService : IImagingService
    {
        ...
        public  Image ScaleImage(Image image, int width, int height,bool zoomAndCrop = false)
        {
            ...
            if (zoomAndCrop)
            {
                ...
                g.DrawImage(image,
                    new Point[]
                                {
                                    new Point(x, y), new Point(x + newWidth, y),
                                    new Point(x, y + newHeight)
                                });
                g.Dispose();
                return newImage;
            }
            else
            {
                ...
                Scale(ref newWidth, ref newHeight, width, height);
        ...
        private  void ZoomAndCrop(ref int width, ref int height, int maxWidth, int maxHeight)
        {
        ...
        private  void Scale(ref int width, ref int height, int maxWidth, int maxHeight)
        {
            ...
            if (maxWidth > 0 && width > maxWidth)
                scale = Math.Min(scale, (float)maxWidth / (float)width);
